...
# 2. Update Hero Section (ONLY up to the Quick Validator)
# We find: `<section class="hero-section ...">` ... `<!-- Quick Validator Widget -->`
hero_pattern = r'<section class="hero-section relative py-20 md:py-28 px-4 text-center overflow-hidden">.*?<!-- Quick Validator Widget -->'

new_hero = """<section class="relative pt-44 pb-20 md:pt-56 md:pb-32 px-4 text-center overflow-hidden" style="background: radial-gradient(100% 120% at 50% 0%, #e0f0ff 0%, #f4f8ff 45%, #ffffff 100%); min-height: 100svh;">
